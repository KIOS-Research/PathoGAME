...
<qgis simplifyDrawingTol="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyDrawingHints="0" simplifyAlgorithm="0" version="3.20.3-Odense" styleCategories="AllStyleCategories" minScale="0" maxScale="0" simplifyMaxScale="1" readOnly="0">
  <flags>
  ...
  <temporal endField="" mode="0" startField="" durationField="" endExpression="" accumulate="0" startExpression="" fixedDuration="0" enabled="0" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 type="singleSymbol" enableorderby="0" symbollevels="0" forceraster="0">
    <symbols>
      <symbol type="marker" alpha="1" force_rhr="0" name="0" clip_to_extent="1">
        ...
        <layer pass="0" enabled="1" class="EllipseMarker" locked="0">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="135,126,227,255" type="QString" name="color"/>
            ...
            <Option value="11.25" type="QString" name="symbol_height"/>
            ...
            <Option value="15" type="QString" name="symbol_width"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory penAlpha="255" sizeType="MM" diagramOrientation="Up" scaleDependency="Area" width="15" barWidth="5" penColor="#000000" height="15" lineSizeType="MM" spacing="0" backgroundAlpha="255" direction="1" spacingUnitScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" rotationOffset="0" lineSizeScale="3x:0,0,0,0,0,0" enabled="0" minimumSize="0" showAxis="0" backgroundColor="#ffffff" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" labelPlacementMethod="XHeight" penWidth="0" opacity="1" maxScaleDenominator="1e+08" spacingUnit="MM">
  ...
  <fieldConfiguration>
    ...
    <field name="initlevel" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="minlevel" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="maxlevel" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="minvolume" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="volumecurv" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <constraints>
    <constraint notnull_strength="2" field="id" constraints="1" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="elevation" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="initlevel" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="minlevel" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="maxlevel" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="diameter" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="minvolume" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="volumecurv" constraints="0" exp_strength="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="desc" constraints="0" exp_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="id" exp="" desc=""/>
    <constraint field="elevation" exp="" desc=""/>
    <constraint field="initlevel" exp="" desc=""/>
    <constraint field="minlevel" exp="" desc=""/>
    <constraint field="maxlevel" exp="" desc=""/>
    <constraint field="diameter" exp="" desc=""/>
    <constraint field="minvolume" exp="" desc=""/>
    <constraint field="volumecurv" exp="" desc=""/>
    <constraint field="desc" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction value="{70a62aaf-45f2-42a0-9e80-cfefa72049f5}" key="Canvas"/>
    <actionsetting capture="0" type="0" icon="" shortTitle="" action="" notificationMessage="" id="{ccb61344-ced0-4ed5-82ed-d0f8e58725df}" name="" isEnabledOnlyWhenEditable="0">
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    <field name="desc" reuseLastValue="0"/>
    <field name="diameter" reuseLastValue="0"/>
    <field name="elevation" reuseLastValue="0"/>
    <field name="id" reuseLastValue="0"/>
    <field name="initlevel" reuseLastValue="0"/>
    <field name="maxlevel" reuseLastValue="0"/>
    <field name="minlevel" reuseLastValue="0"/>
    <field name="minvolume" reuseLastValue="0"/>
    <field name="volumecurv" reuseLastValue="0"/>
  </reuseLastValue>
